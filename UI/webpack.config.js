...
const CSII_LOCALMODSPATH = process.env.CSII_LOCALMODSPATH;
const CSII_MODS_OUTPUT_DIR = CSII_LOCALMODSPATH || (CSII_USERDATAPATH ? path.join(CSII_USERDATAPATH, "Mods") : undefined);

if (!CSII_MODS_OUTPUT_DIR) {
  throw "CSII_LOCALMODSPATH or CSII_USERDATAPATH environment variable is not set, ensure the CSII Modding Toolchain is installed correctly";
}

const OUTPUT_DIR = path.join(CSII_MODS_OUTPUT_DIR, MOD.id);
